document.addEventListener('DOMContentLoaded', (event) => {
  ...
  x = setInterval(function() {
    ...
    if (distance > 0) {
      ...
      function init() {
        ...
        box.addEventListener('click', showImages, false); // Add this line
      }
  ...
  function updateCountdown() {
    console.log("Updating countdown"); // Debug log
    ...
    // ...existing code to calculate and update countdown...
  }

  // ...existing code to set interval for updateCountdown...
});
